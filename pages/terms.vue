      ...
      <div class="container">
        ...
        <div class="text">
          ...
          <p>
            ...
            related to it, still belong to Yammluck.
          </p>
          <p>
            Yammluck is committed to ensuring that the app is as useful and
          ...
          <p>
            The Yammluck app stores and processes personal data that you have
            ...
            phone’s security features and it could mean that the Yammluck app
          ...
          <p>
            You should be aware that there are certain things that Yammluck will
            ...
            but Yammluck cannot take responsibility for the app not working at
          ...
          <p>
            Along the same lines, Yammluck cannot always take responsibility for
            ...
            to avail the Service, Yammluck cannot accept responsibility.
          </p>
          <p>
            With respect to Yammluck’s responsibility for your use of the app,
            ...
            that we can make it available to you. Yammluck accepts no liability
          ...
          <p>
            ...
            the updates if you want to keep using the app. Yammluck does not
          ...
          <p>
            ...
            Conditions, do not hesitate to contact us at yammluck@gmail.com.
          </p>
          <p>
