    ...
    <div class="privacy-page">
      <div class="container">
        <div class="breadcrumb">
          ...
          <span class="page">{{ $t("privacy-policy") }}</span>
        </div>
        <div class="text">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Yammluck.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Yammluck, accessible from
                <a
                  href="https://yammluck.net"
                  rel="external nofollow noopener"
                  target="_blank"
                  >https://yammluck.net</a
                >
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>By email: yammluck@gmail.com</li>
          </ul>
        </div>
      </div>
    </div>
